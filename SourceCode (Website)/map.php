...
$sql = "SELECT Latitude, Longitude, Visibility FROM a3038225_friend.members where id = '".$_SESSION['SESS_MEMBER_ID']."'";
...
?>
  ...
  <body onload="initialize()">    <div id="map_canvas" style="width:100%; height:90%"></div> 

  	
          </body><font color='black' face = 'Bell MT' size="3">
		 ...
		 echo ("The Page will refresh after every 15 seconds if the location is being updated through the phone");
		  ...
		  <meta http-equiv="refresh" content="15; url='map.php"> 
		  </html>
